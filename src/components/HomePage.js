...
const box = {
	...
	backgroundImage: `linear-gradient(to right, ${palette(
		'white'
	)} 50px, transparent 1px), linear-gradient(${palette(
		'primary'
	)} 100px, transparent 1px)`,
...
const reviewSection = {
	backgroundImage:
		'linear-gradient(rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0.6)),url(./images/popcorn.jpg)',
...
const signUpSection = {
	backgroundImage:
		'linear-gradient(rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0.6)),url(./images/sock.jpg)',
	backgroundPosition: 'center',
	backgroundSize: 'cover',
	padding: '1% 10% 4%',
};
			...
			<div style={headerDivStyle}>
				...
				<div style={flexHead}>
					...
					<div style={titleButtons}>
						...
						<h5 style={headerText}>
							what someone means when they say "add it to my list"
						</h5>
						<ModalButton>
				...
				<div className='container' style={iconSection}>
					<div className='row'>
						<div className='col-lg-4 col-md-6 col-sm-12' style={iconBox}>
							...
							<p style={iconCaption}>
								Maintain your list of shows that are currently available on
						...
						<div className='col-lg-4 col-md-6 sol-sm-12' style={iconBox}>
							...
							<p style={iconCaption}>
								"flick" and "be flicked" - Share viewing recommendations with
								your friends
							</p>
						</div>
						<div className='col-lg-4 col-md-6 sol-sm-12' style={iconBox}>
							...
							<p style={iconCaption}>
								Feel accomplished knowing you're finally keeping track of those
								movies and shows you've been meaning to watch
							</p>
						</div>
					</div>
				</div>
					...
					<li style={streamListItem}>
						<figure style={logoImage}>
							<img
								style={logo}
								src='./images/text.png'
								alt='let us know what service you use, from these to so many more'
							/>
						</figure>
					</li>
				</ul>
				...
				<div className='row'>
					<div className='col-lg-12 col-md-6 col-sm-12' style={quoteBlock}>
						<blockquote style={quote}>
							"It's so nice being able to share my interests with my friends. I
							can honestly say 'I will definitely watch that!' now"
						</blockquote>
						<cite style={customer}>- Andrew J</cite>
					</div>
					<div className='col-lg-6 col-md-6 col-sm-12' style={quoteBlock}>
						<blockquote style={quote}>
							"I don't have to try to mentally keep track of my list of shows-
							or who recommended them!"
						</blockquote>
						<cite style={customer}>- Debbie S</cite>
					</div>
					<div className='col-lg-6 col-md-12 col-sm-12' style={quoteBlock}>
						<blockquote style={quote}>
							"My friends can actually see what shows I have access to, so now
							they don't recommend things I can't watch. It makes my list so
